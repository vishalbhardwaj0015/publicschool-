...
<main class="landing-page">
    ...
    <section class="section">
        <div class="section-text">
            ...
            <div class="section-buttons">
                ...
                <a href="user/login.php" class="lp-btn lp-btn-primary">Student / Parent Login</a>
                <a href="user/register.php" class="lp-btn lp-btn-vs">New Admission</a>
            </div>

            <div class="section-highlights">
                <div class="school">Holistic Development</div>
                <div class="school">Smart Classrooms</div>
                <div class="school">Co-curricular Focus</div>
            </div>
        </div>
    ...
    <section class="section-features">
        ...
        <div class="feature-grid">
            <div class="feature-card">
                ...
                <p>Highly qualified and dedicated staff to guide every student personally.</p>
            </div>

            <div class="feature-card">
                <h3>Modern Learning</h3>
                <p>Smart classes, activity-based learning and regular assessments.</p>
            </div>

            <div class="feature-card">
                <h3>Safe Campus</h3>
                <p>Child-friendly, secure environment with proper supervision everywhere.</p>
            </div>
        </div>
    </section>
    ...
    <section class="section-gallery">
        ...
        <p class="section-subtitle">A glimpse of our classrooms, activities and events.</p>
        ...
        <div class="gallery-grid">
            ...
            <article class="gallery-card">
                ...
                <div class="gallery-content">
                    <h3>playground</h3>
                    <p>Our school playground is a vibrant space where children learn, play, and grow together. It's designed to encourage teamwork, physical activity, and joyful exploration.</p>
                    <a href="#" class="gallery-link">Projects →</a>
                </div>
            </article>
    ...
    <section class="Admissions-section">
        <div class="Admissions-open">
            ...
            <div class="Admissions-buttons">
                <a href="user/register.php" class="lp-btn lp-btn-primary">Contact School</a>
                <a href="user/register.php" class="lp-btn lp-btn-primary">Online Registration</a>
            </div>
        </div>
    </section>
